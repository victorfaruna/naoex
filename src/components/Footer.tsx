  ...
  return (
       <footer id="footer">
        <div className="footer-main">
            <Image src={require("@/assets/images/backgroup/bg-ft.png")} className="bg1" alt=""/>
            <Image src={require("@/assets/images/backgroup/bg-ft2.png")} className="bg2" alt=""/>
            <div className="container">
                <ul className="widget-social">
                    <li>
                        <a href="#">
                            <Image src={require("@/assets/images/logo/x.svg")} width="30" height="28" alt=""/>
                                                    
                        </a>
                    </li>
                    <li>
                        <Link href="#">
                            <Image src={require("@/assets/images/logo/linkedin.svg")} width="30" height="28" alt=""/>         
                        </Link>
                    </li>
                    <li>
                        <a href="#">
                ...
                <p>NanoEx Holdings Limited is a Limited Company registered in Cyprus with Registration Number Cxxxxxxxx <br/>and in Nigeria with Registration Number RCxxxxxxxx.</p>
