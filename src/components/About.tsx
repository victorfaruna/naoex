                        ...
                        <div className="col-md-7">
                            ...
                            >
                                <div className="box-text corner-box">
                                    ...
                                    <p>
                                        Invest in assets with minimal capital
                                        through blockchain fractional ownership.
                                    </p>
                                </div>
                                <div className="box-text corner-box">
                                    <div className="h7">
                                        Instant Settlement & Transfers
                                    </div>
                                    <p>
                                        Tokenized assets enable instant
                                        settlement, reducing delays and
                                ...
                                <div className="box-text corner-box mb-0">
                                    ...
                                    <p>
                                        Tokenized assets offer 24/7 trading,
                                        enabling global, nonstop investment
                                        opportunities.
                                    </p>
                                </div>
                            </div>
